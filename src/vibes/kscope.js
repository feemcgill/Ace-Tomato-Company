  ...
  draw() {
    ...
    const createKScope = () => {
      ...
      for (let i = 0; i < this.slices; i++) {
        let spriteTileArc = new PIXI.TilingSprite(
          this.image,
          1500 * 2,
          1500 * 2
        )
    ...
    pixi_app.ticker.add(() => {
      ...
      for (let i = 0; i < this.spriteTiles.length; i++) {
        TweenMax.to(this.spriteTiles[i].tilePosition, 35, {
          x: this.mouseX + this.count,
          y: this.mouseY + this.count,
        })
      }
      if (appState.audioKicking) {
        ...
        let r = mapRange(
          dataArray[this.settings.moveData[0]],
          0,
          255,
          0.95,
          1.5
        ...
        let s = mapRange(
          dataArray[this.settings.moveData[1]],
          0,
          255,
          0.95,
          1.5
