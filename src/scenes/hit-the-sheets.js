...
export default class HitTheSheets extends PIXI.Container {
  ...
  run() {
    ...
    const pj = new PhotoJam(pixi_app.loader.resources.hts_4.texture, 3, null, [11,12,13,14], [1, 1.5], 10)
    pj.transitionIn();
    ...
    const kscope = new Kaleidoscope(pixi_app.loader.resources.hts_3.texture, 2, [30,26])
    kscope.draw()
